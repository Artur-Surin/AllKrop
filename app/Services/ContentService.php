            ...
            [
                ...
                'items' => [
                    [
                        ...
                        'description' => 'Замовлення довідок про склад сім\'ї, місце проживання онлайн.',
                        'action' => 'Замовити довідку',
                        'steps' => [
                            'Увійдіть у кабінет мешканця на порталі',
                            'Оберіть тип довідки зі списку',
                            'Заповніть онлайн-заяву та прикріпіть копію паспорта',
                            'Отримайте готову довідку на електронну пошту або в ЦНАПі',
                        ],
                        ...
                        'delivery' => 'Онлайн / В офісі',
                        'faq' => [
                            ['q' => 'Які довідки можна отримати онлайн?', 'a' => 'Довідка про склад сім\'ї, довідка про реєстрацію місця проживання, витяг з реєстру територіальної громади.'],
                    ...
                    [
                        ...
                        'description' => 'Подання заяви на реєстрацію без черг у ЦНАПі.',
                        'action' => 'Подати заяву',
                        'steps' => [
                            'Заповніть онлайн-заяву на порталі',
                            'Прикріпіть необхідні документи',
                            'Оберіть зручний час візиту до ЦНАПу',
                            'Відвідайте ЦНАП для підтвердження документів',
                    ...
                    [
                        ...
                        'steps' => [
                            ...
                            'Подайте заяву на отримання «єМалятко»',
                        ...
                        'delivery' => 'Онлайн / В офісі / Поштою',
                        'faq' => [
            ...
            [
                ...
                'items' => [
                    [
                        ...
                        'description' => 'Сплата за воду, тепло, вивіз сміття в один клік.',
                        'action' => 'Сплатити',
                        'steps' => [
                            'Увійдіть у кабінет мешканця',
                            'Перевірте нараховані суми за період',
                            'Оберіть спосіб оплати (карта, Apple Pay, Google Pay)',
                            'Підтвердіть платіж',
                    ...
                    [
                        ...
                        'steps' => [
                            'Оберіть тип проблеми з каталогу',
                            'Вкажіть адресу та опис проблеми',
                            'Прикріпіть фотографію (за бажанням)',
                            'Відправте заявку та отримайте номер',
                    ...
                    [
                        ...
                        'steps' => [
                            ...
                            'Подайте заяву через «Трембіту» або в ЦНАПі',
                ...
                'items' => [
                    [
                        ...
                        'steps' => [
                            ...
                            'Заповніть форму з описом питання',
                            'Прикріпіть файли (фото, документи)',
                            'Відправте та отримайте реєстраційний номер',
                            'Стежте за статусом розгляду',
                        ],
                        'documents' => ['Не потрібно (для петицій — мінімум 250 підписів)'],
                        'cost' => 'Безкоштовно',
                        'timeline' => 'Відповідь: до 15 робочих днів',
                        'delivery' => 'Онлайн / Поштою',
                        'faq' => [
                    ...
                    [
                        ...
                        'action' => 'До проєктів',
                        'steps' => [
                            'Ознайомтеся з правилами участі',
                            'Підготуйте проєкт з бюджетом та обґрунтуванням',
                            'Подайте проєкт онлайн до встановленого дедлайну',
